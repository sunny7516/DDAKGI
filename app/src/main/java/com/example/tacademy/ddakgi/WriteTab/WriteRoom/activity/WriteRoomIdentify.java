...
public class WriteRoomIdentify extends AppCompatActivity {
    ...
    // Toolbar에 option Menu
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater inflater = getMenuInflater();
        inflater.inflate(R.menu.roomidentify_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            // back Button
            case R.id.roomIdentifyBack:
                this.finish();
                return true;
            case R.id.roomIdentifyFinish:
                // 서버에 등록하기
                return true;
        }
    ...
    public void getPhoto(View view) {
        //if (havePhoto == null) {
        ImageButton roomIdentifyBt = (ImageButton) findViewById(view.getId());
        if (roomIdentifyBt.getTag() == null) {
            ...
            alert = new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                    .setContentText("삭제 / 재설정")
                    .setConfirmText("삭제")
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        @Override
                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                            //deleteImage(roomImageBt.getTag());
                        }
                    })
                    .setCancelText("재설정")
