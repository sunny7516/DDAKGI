...
/**
 * 방 있는 룸메이트 글 수정 요청 모델
 */

public class ReqModifyRoom {
    String title;
    String local1;
    String local2;
    String local3;
    ...
    public ReqModifyRoom(String title, String local1, String local2, String local3,
                         String detailed_local, double room_latitude, double room_longitude,
                         int room_type, int size, int deposit, int rent, int floor,
                         String available_date, int manage_cost, int manage_cost_inc,
                         int options, String description, String extra_q1, String extra_q2,
                         String extra_q3) {
        this.title = title;
        this.local1 = local1;
        this.local2 = local2;
