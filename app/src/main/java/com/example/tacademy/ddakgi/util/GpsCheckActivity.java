...
public class GpsCheckActivity extends AppCompatActivity {

    public static Activity gpscheckActivity;
    int goType = 0;
        ...
        try {
            ...
            if (addressList != null && addressList.size() > 0) {
                ...
                for (Address address : addressList) {
                    Log.i("GPS", address.toString() + address.getSubThoroughfare());
                    //getThoroughfare 동단위 정보
                    //getSubThoroughfare 세부단위 정보
                }
